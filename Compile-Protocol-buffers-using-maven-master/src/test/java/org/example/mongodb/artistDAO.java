...
public class artistDAO {
	...
	ConnectionString connectionString = new ConnectionString("mongodb+srv://coen424demo:coen424pwd@cluster0.s3wpdyd.mongodb.net/?retryWrites=true&w=majority");
	MongoClientSettings settings = MongoClientSettings.builder()
	        .applyConnectionString(connectionString)
	        .build();
	MongoClient mongoClient = MongoClients.create(settings);
	MongoDatabase database = mongoClient.getDatabase("coen424");
